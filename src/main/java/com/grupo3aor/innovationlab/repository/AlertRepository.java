...
public interface AlertRepository extends JpaRepository<Alert, UUID> {
    ...
    @org.springframework.data.jpa.repository.Query("UPDATE Alert a SET a.active = false, a.updatedAt = CURRENT_TIMESTAMP WHERE a.simulation.id = :simId AND a.createdAt > :timestamp")
